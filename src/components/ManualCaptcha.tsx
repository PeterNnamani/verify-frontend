...
const RecaptchaLogo = () => (
  <svg width='32' height='32' viewBox='0 0 32 32' style={{ marginRight: 8 }}>
    <g>
      ...
      <path
        d='M16 6a10 10 0 0 1 9.95 9.1h-2.02A8 8 0 1 0 24 18h-3v2h6v-6h-2v2.08A10 10 0 1 1 16 6z'
        fill='#4285f4'
      />
      <path
        d='M16 26a10 10 0 0 1-9.95-9.1h2.02A8 8 0 1 0 8 14h3v-2H5v6h2v-2.08A10 10 0 1 1 16 26z'
        fill='#34a853'
      />
    </g>
  </svg>
...
export const ManualCaptcha: React.FC<{ onVerified: () => void }> = ({
  onVerified,
}) => {
    ...
    <div className='captcha-container'>
      ...
      >
        ...
        <div style={{ display: 'flex', alignItems: 'center', marginBottom: 8 }}>
          <div
            className={`checkbox-fake${verified ? ' checked' : ''}`}
            style={{ marginRight: 10 }}
          />
          {!clicked && !verified && (
            <span style={{ color: '#555' }}>Click the box to continue</span>
          )}
        </div>
        {loading && (
